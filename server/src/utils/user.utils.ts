...
export const findOrganizationByUserId = async (
  ...
  const org = await OrganizationMembership.findOne({
    userId: userId,
    orgId: orgId,
  }).lean();
  return org;
...
export const checkOrganizationMembershipByUserIdAndOrgId = async (
  userId: string,
  orgId: string,
) => {
...
export const checkProjectMembershipByUserIdAndProjectId = async (
  userId: string,
  projectId: string,
) => {
  const projectMembership = await ProjectMembership.findOne({
...
export const findOrganizationMembershipByUserIdAndOrgId = async (
  userId: string,
  orgId: string,
) => {
  const orgMembership = await OrganizationMembership.findOne({
